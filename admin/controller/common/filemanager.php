...
class ControllerCommonFileManager extends Controller {
	public function index() {
		...
		// Get files
		$filesJpg = glob($directory . '/' . $filter_name . 	'*.jpg');
		$filesJpeg = glob($directory . '/' . $filter_name . '*.jpeg');
		$filesGif = glob($directory . '/' . $filter_name . 	'*.gif');
		$filesPng = glob($directory . '/' . $filter_name . 	'*.png');
		
		if(!$filesJpg) 	$filesJpg = array();
		if(!$filesJpeg) $filesJpeg = array();
		if(!$filesPng) 	$filesPng = array();
		if(!$filesGif) 	$filesGif = array();

		$files = array_merge($filesJpg, $filesJpeg, $filesPng, $filesGif);
