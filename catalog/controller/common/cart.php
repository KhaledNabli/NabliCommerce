...
class ControllerCommonCart extends Controller {
	public function index() {
		...
		$data['text_item_count'] = sprintf($this->language->get('text_item_count'), $this->cart->countProducts() + (isset($this->session->data['vouchers']) ? count($this->session->data['vouchers']) : 0));
